...
class PortswitchTest(BfRuntimeTest):
    def setUp(self):
        ...
        self.table_flow_state_congestion_update1='SwitchIngress.flow_state_congestion_update1_0'
        self.action_fstate1_congestion_plus='SwitchIngress.fstate1_0_congestion_plus'
        self.action_fstate1_congestion_update='SwitchIngress.fstate1_0_congestion_update'
        self.action_fstate1_congestion_read='SwitchIngress.fstate1_0_congestion_read'
        self.table_flow_state_congestion_update2='SwitchIngress.flow_state_congestion_update2_0'
        self.action_fstate2_congestion_plus='SwitchIngress.fstate2_0_congestion_plus'
        self.action_fstate2_congestion_update='SwitchIngress.fstate2_0_congestion_update'
        self.action_fstate2_congestion_read='SwitchIngress.fstate2_0_congestion_read'
        ...
        try:
            ...
            self.flow_state_update1_table.entry_add(
                ...
                [self.flow_state_update1_table.make_key(
                    [ gc.KeyTuple('flow_monitor_flag', 1), gc.KeyTuple('cur_flow_time_window', 0), gc.KeyTuple('global_time_window', 0), gc.KeyTuple('cur_defense_type', 4)]
                )],
            ...
            self.flow_state_update1_table.entry_add(
                self.target,
                [self.flow_state_update1_table.make_key(
                    [ gc.KeyTuple('flow_monitor_flag', 1), gc.KeyTuple('cur_flow_time_window', 0), gc.KeyTuple('global_time_window', 1), gc.KeyTuple('cur_defense_type', 4)]
                )],
                [self.flow_state_update1_table.make_data(
                    [],
            ...
            self.flow_state_update1_table.entry_add(
                self.target,
                [self.flow_state_update1_table.make_key(
                    [ gc.KeyTuple('flow_monitor_flag', 1), gc.KeyTuple('cur_flow_time_window', 1), gc.KeyTuple('global_time_window', 1), gc.KeyTuple('cur_defense_type', 4)]
                )],
                [self.flow_state_update1_table.make_data(
                    [],
                    self.action_fstate1_read
            ...
            self.flow_state_update1_table.entry_add(
                self.target,
                [self.flow_state_update1_table.make_key(
                    [ gc.KeyTuple('flow_monitor_flag', 1), gc.KeyTuple('cur_flow_time_window', 1), gc.KeyTuple('global_time_window', 0), gc.KeyTuple('cur_defense_type', 4)]
                )],
                [self.flow_state_update1_table.make_data(
                    [],
            ...
            self.flow_state_congestion_update1_table.entry_add(
                ...
                [self.flow_state_congestion_update1_table.make_key(
                    [ gc.KeyTuple('flow_monitor_flag', 1), gc.KeyTuple('cur_flow_time_window', 0), gc.KeyTuple('global_time_window', 0), gc.KeyTuple('cur_defense_type', 3)]
                )],
            ...
            self.flow_state_congestion_update1_table.entry_add(
                self.target,
                [self.flow_state_congestion_update1_table.make_key(
                    [ gc.KeyTuple('flow_monitor_flag', 1), gc.KeyTuple('cur_flow_time_window', 0), gc.KeyTuple('global_time_window', 1), gc.KeyTuple('cur_defense_type', 3)]
                )],
                [self.flow_state_congestion_update1_table.make_data(
                    [],
            ...
            self.flow_state_congestion_update1_table.entry_add(
                self.target,
                [self.flow_state_congestion_update1_table.make_key(
                    [ gc.KeyTuple('flow_monitor_flag', 1), gc.KeyTuple('cur_flow_time_window', 1), gc.KeyTuple('global_time_window', 1), gc.KeyTuple('cur_defense_type', 3)]
                )],
                [self.flow_state_congestion_update1_table.make_data(
                    [],
                    self.action_fstate1_congestion_read
            ...
            self.flow_state_congestion_update1_table.entry_add(
                self.target,
                [self.flow_state_congestion_update1_table.make_key(
                    [ gc.KeyTuple('flow_monitor_flag', 1), gc.KeyTuple('cur_flow_time_window', 1), gc.KeyTuple('global_time_window', 0), gc.KeyTuple('cur_defense_type', 3)]
                )],
                [self.flow_state_congestion_update1_table.make_data(
                    [],
